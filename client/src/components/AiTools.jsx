  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
        <div className='text-center'>
            ...
            <p className='text-grey-500 max-w-lg mx-auto'>Everything you need to create , enhance, and optimize your content with
        ...
        <div className='flex flex-wrap mt-10 justify-center'>
            {AiToolsData.map(( tool, index)=>(
                ...
                duration-300 curser-pointer' onClick={()=> user && navigate(tool.path)}>
