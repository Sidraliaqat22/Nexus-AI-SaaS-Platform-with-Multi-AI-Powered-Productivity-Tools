// creat this file to publish the creations of user and also to show the history of creations
import sql from '../configs/db.js';

// function to publish the creation of user
...
//  get published creations of all users fuction 
